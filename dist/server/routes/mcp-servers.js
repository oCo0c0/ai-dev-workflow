...
exports.createMCPServersRoutes = createMCPServersRoutes;
...
function createMCPServersRoutes(mcpConfigService, cliRunnerService) {
    ...
    router.get('/', async (_req, res) => {
        try {
            ...
            res.status(500).json({ code: 'MCP_CONFIG_ERROR', message: (0, error_utils_js_1.getErrorMessage)(err) });
        }
    });
    ...
    router.post('/', (0, validation_js_1.validateBody)([
        ...
        try {
            ...
            res.status(400).json({ code: 'MCP_CONFIG_ERROR', message: (0, error_utils_js_1.getErrorMessage)(err) });
        }
    });
