 ...
 */
function createAnalyticsRoutes(analyticsService, memoryService) {
    ...
    router.get('/summary', (_req, res) => {
        try {
            ...
            res.status(500).json({ code: 'ANALYTICS_ERROR', message: (0, error_utils_js_1.getErrorMessage)(err) });
        }
    });
    /**
    ...
    router.get('/memory/profile', (_req, res) => {
        ...
        try {
            ...
            res.status(500).json({ code: 'MEMORY_ERROR', message: (0, error_utils_js_1.getErrorMessage)(err) });
        }
    });
    /**
