...
exports.addIterationLimit = addIterationLimit;
exports.addEarlyTermination = addEarlyTermination;
exports.improveObservation = improveObservation;
exports.applyAgentOptimizations = applyAgentOptimizations;
/**
 * 为Agent的decide方法添加统一的迭代限制
 */
function addIterationLimit(originalDecide, maxIterations = 5) {
 ...
 */
function addEarlyTermination(originalThink, qualityThreshold = 0.9) {
    return async function (context) {
 ...
 */
function improveObservation(originalObserve) {
    return async function (context, result) {
 ...
 * 应用所有优化到Agent
 */
function applyAgentOptimizations(agent) {
    const config = {
        maxIterations: 4,
