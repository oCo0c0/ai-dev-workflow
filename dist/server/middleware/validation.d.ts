 ...
 */
export declare function validateShellSafeInput(value: unknown, fieldName: string): string;
 ...
 * ]), handler);
 */
export declare function validateBody(rules: FieldRule[]): (req: Request, res: Response, next: NextFunction) => void;
/**
 * 全局错误处理中间件
 *
 ...
 * @returns 清理后的名称
 */
export declare function sanitizePathComponent(name: string): string;
/**
 ...
 */
export declare function validateWorkspacePath(workspacePath: string, allowedRoots?: string[]): {
    valid: boolean;
    path?: string;
    error?: string;
};
 ...
 * @returns 校验结果，valid 为 true 时 path 为规范化后的路径
 */
export declare function validateOutputPath(outputPath: string, allowedRoots: string[]): {
    valid: boolean;
    path?: string;
    error?: string;
};
