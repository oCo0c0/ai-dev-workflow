 ...
 *   交由适配器走 Markdown 解析。
 */
export function extractContentJson(content) {
 ...
 */
export function parseMarkdownRequirementList(text) {
    const results = [];
 ...
 */
export function parseMarkdownRequirementDetail(text, options) {
    const lines = text.split('\n');
