...
const TOOL_META: Record<string, ToolMeta> = {
    ...
    ripgrep: {variant: 'search', title: '内容搜索', icon: Search},
    fd: {variant: 'search', title: '文件查找', icon: FolderSearch},
    search: {variant: 'search', title: '搜索', icon: Search},
    toolsearch: {variant: 'search', title: '工具搜索', icon: Search},
    tool_search: {variant: 'search', title: '工具搜索', icon: Search},
    codesearch: {variant: 'search', title: '代码搜索', icon: Search},
    questionnaire: {variant: 'task', title: '问卷确认', icon: Bot},
    askuserquestion: {variant: 'task', title: '询问用户', icon: Bot},
    exitplanmode: {variant: 'task', title: '退出计划模式', icon: Bot},
    slashcommand: {variant: 'task', title: '命令调用', icon: Bot},
    local_image: {variant: 'read', title: '查看图片', icon: FileText},
    view_image: {variant: 'read', title: '查看图片', icon: FileText},
